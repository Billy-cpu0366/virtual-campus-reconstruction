...
| `03-执行层/01-地图线/03-图层与遮挡.md` | 回写FACT、INFERRED、DECISION、UNKNOWN、场景结果和验证标准；不能静默改变已接受决定 |
| `03-执行层/00-总账.md` | 同步理解/工程状态、可重复BASE差距和`Q-LAYER-001/002`状态 |
| `决策记录.md` | Human决定、签字和验证基线摘要；动态状态不写这里 |
| `findings.md` | 非权威发现记录 |
| `progress.md` | 非权威进度记录 |
