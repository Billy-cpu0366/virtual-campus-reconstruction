...
原子激活提交 `981a21e54ed7cd3eac3ec3bc5b26ce12bd8086a4` 已通过治理检查并进入 clean Git 基线。当前只允许建立 `src/chunk/*.ts`、`tests/chunk/*.test.ts` 及授权包列出的最小工程文件；Phaser、Vite、浏览器、网络请求、缓存、渲染和旧项目修改仍未授权。
